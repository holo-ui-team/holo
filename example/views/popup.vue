<template>
  <div>
    ...
    <section>
      有三个按钮
      <button @click="visible3 = !visible3">切换状态</button>
    ...
    <section>
      两个按钮，主要按钮为危险按钮
      <button @click="visible4 = !visible4">切换状态</button>
