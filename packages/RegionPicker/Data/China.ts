export default {
  ...
  '河北省'          : {
    '石家庄市': [
      '长安区', '桥西区', '新华区', '井陉矿区', '裕华区', '藁城区', '鹿泉区', '栾城区', '井陉县', '正定县', '行唐县', '灵寿县', '高邑县', '深泽县', '赞皇县', '无极县', '平山县', '元氏县', '赵县',
      '石家庄高新技术产业开发区', '石家庄循环化工园区', '辛集市', '晋州市', '新乐市',
    ],
    '唐山市'  : [
      '路南区', '路北区', '古冶区', '开平区', '丰南区', '丰润区', '曹妃甸区', '滦南县', '乐亭县', '迁西县', '玉田县', '河北唐山芦台经济开发区', '唐山市汉沽管理区', '唐山高新技术产业开发区',
      '河北唐山海港经济开发区', '遵化市', '迁安市', '滦州市',
    ],
    '秦皇岛市': [ '海港区', '山海关区', '北戴河区', '抚宁区', '青龙满族自治县', '昌黎县', '卢龙县', '秦皇岛市经济技术开发区', '北戴河新区' ],
    '邯郸市'  : [
      '邯山区', '丛台区', '复兴区', '峰峰矿区', '肥乡区', '永年区', '临漳县', '成安县', '大名县', '涉县', '磁县', '邱县', '鸡泽县', '广平县', '馆陶县', '魏县', '曲周县', '邯郸经济技术开发区',
      '邯郸冀南新区', '武安市',
    ],
    '邢台市'  : [
      '襄都区', '信都区', '任泽区', '南和区', '临城县', '内丘县', '柏乡县', '隆尧县', '宁晋县', '巨鹿县', '新河县', '广宗县', '平乡县', '威县', '清河县', '临西县', '河北邢台经济开发区', '南宫市',
      '沙河市',
    ],
    '保定市'  : [
      '竞秀区', '莲池区', '满城区', '清苑区', '徐水区', '涞水县', '阜平县', '定兴县', '唐县', '高阳县', '容城县', '涞源县', '望都县', '安新县', '易县', '曲阳县', '蠡县', '顺平县', '博野县', '雄县',
      '保定高新技术产业开发区', '保定白沟新城', '涿州市', '定州市', '安国市', '高碑店市',
    ],
    '张家口市': [
      '桥东区', '桥西区', '宣化区', '下花园区', '万全区', '崇礼区', '张北县', '康保县', '沽源县', '尚义县', '蔚县', '阳原县', '怀安县', '怀来县', '涿鹿县', '赤城县', '张家口经济开发区',
      '张家口市察北管理区', '张家口市塞北管理区',
    ],
    '承德市'  : [ '双桥区', '双滦区', '鹰手营子矿区', '承德县', '兴隆县', '滦平县', '隆化县', '丰宁满族自治县', '宽城满族自治县', '围场满族蒙古族自治县', '承德高新技术产业开发区', '平泉市' ],
    '沧州市'  : [
      '新华区', '运河区', '沧县', '青县', '东光县', '海兴县', '盐山县', '肃宁县', '南皮县', '吴桥县', '献县', '孟村回族自治县', '河北沧州经济开发区', '沧州高新技术产业开发区', '沧州渤海新区',
      '泊头市', '任丘市', '黄骅市', '河间市',
    ],
  ...
  '内蒙古自治区'    : {
    ...
    '呼伦贝尔市': [
      '海拉尔区', '扎赉诺尔区', '阿荣旗', '莫力达瓦达斡尔族自治旗', '鄂伦春自治旗', '鄂温克族自治旗', '陈巴尔虎旗', '新巴尔虎左旗', '新巴尔虎右旗', '满洲里市', '牙克石市', '扎兰屯市', '额尔古纳市',
      '根河市',
    ],
  ...
  '吉林省'          : {
    '长春市'          : [
      '南关区', '宽城区', '朝阳区', '二道区', '绿园区', '双阳区', '九台区', '农安县', '长春经济技术开发区', '长春净月高新技术产业开发区', '长春高新技术产业开发区', '长春汽车经济技术开发区', '榆树市',
      '德惠市', '公主岭市',
    ],
  ...
  '河南省'          : {
    '郑州市'            : [
      '中原区', '二七区', '管城回族区', '金水区', '上街区', '惠济区', '中牟县', '郑州经济技术开发区', '郑州高新技术产业开发区', '郑州航空港经济综合实验区', '巩义市', '荥阳市', '新密市', '新郑市',
      '登封市',
    ],
    ...
    '新乡市'            : [
      '红旗区', '卫滨区', '凤泉区', '牧野区', '新乡县', '获嘉县', '原阳县', '延津县', '封丘县', '新乡高新技术产业开发区', '新乡经济技术开发区', '新乡市平原城乡一体化示范区', '卫辉市', '辉县市',
      '长垣市',
    ],
  ...
  '广东省'          : {
    ...
    '东莞市': [
      '东城街道', '南城街道', '万江街道', '莞城街道', '石碣镇', '石龙镇', '茶山镇', '石排镇', '企石镇', '横沥镇', '桥头镇', '谢岗镇', '东坑镇', '常平镇', '寮步镇', '樟木头镇', '大朗镇', '黄江镇',
      '清溪镇', '塘厦镇', '凤岗镇', '大岭山镇', '长安镇', '虎门镇', '厚街镇', '沙田镇', '道滘镇', '洪梅镇', '麻涌镇', '望牛墩镇', '中堂镇', '高埗镇', '松山湖', '东莞港', '东莞生态园',
      '东莞滨海湾新区',
    ],
    '中山市': [
      '石岐街道', '东区街道', '中山港街道', '西区街道', '南区街道', '五桂山街道', '民众街道', '南朗街道', '黄圃镇', '东凤镇', '古镇镇', '沙溪镇', '坦洲镇', '港口镇', '三角镇', '横栏镇', '南头镇',
      '阜沙镇', '三乡镇', '板芙镇', '大涌镇', '神湾镇', '小榄镇',
    ],
    '潮州市': [ '湘桥区', '潮安区', '饶平县' ],
  ...
  '海南省'          : {
    ...
    '儋州市'            : [
      '那大镇', '和庆镇', '南丰镇', '大成镇', '雅星镇', '兰洋镇', '光村镇', '木棠镇', '海头镇', '峨蔓镇', '王五镇', '白马井镇', '中和镇', '排浦镇', '东成镇', '新州镇', '洋浦经济开发区',
      '华南热作学院',
    ],
    '省直辖县级行政区划': [
      '五指山市', '琼海市', '文昌市', '万宁市', '东方市', '定安县', '屯昌县', '澄迈县', '临高县', '白沙黎族自治县', '昌江黎族自治县', '乐东黎族自治县', '陵水黎族自治县', '保亭黎族苗族自治县',
      '琼中黎族苗族自治县',
    ],
  },
  '重庆市'          : {
    '市辖区': [
      '万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '綦江区', '大足区', '渝北区', '巴南区', '黔江区', '长寿区', '江津区', '合川区', '永川区',
      '南川区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区',
    ], '县' : [ '城口县', '丰都县', '垫江县', '忠县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县' ],
  },
  '四川省'          : {
    '成都市'            : [
      '锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', '双流区', '郫都区', '新津区', '金堂县', '大邑县', '蒲江县', '都江堰市', '彭州市', '邛崃市',
      '崇州市', '简阳市',
    ],
  ...
  '澳门特别行政区'  : {
    '澳门半岛': [ '大堂区', '望德堂区', '风顺堂区', '花地玛堂区', '圣安多尼堂区', ],
    '澳门外岛': [ '嘉模堂区（氹仔）', '圣方济各堂区（路环）', ],
  },
  '台湾省'          : {
    ...
    '台南市': [
      '永康区', '安南区', '东区', '北区', '南区', '中西区', '新营区', '仁德区', '归仁区', '安平区', '佳里区', '善化区', '麻豆区', '新化区', '新市区',
      '关庙区', '安定区', '白河区', '学甲区', '盐水区', '西港区', '下营区', '后壁区', '七股区', '六甲区', '官田区', '柳营区', '东山区',
      '将军区', '玉井区', '北门区', '大内区', '楠西区', '南化区', '山上区', '左镇区', '龙崎区',
    ],
    '高雄市': [
      '凤山区', '三民区', '左营区', '前镇区', '楠梓区', '苓雅区', '小港区', '鼓山区', '大寮区', '冈山区', '仁武区', '林园区', '路竹区', '新兴区', '鸟松区', '大树区',
      '美浓区', '桥头区', '旗山区', '梓官区', '大社区', '茄萣区', '燕巢区', '湖内区', '阿莲区', '旗津区', '前金区', '盐埕区', '弥陀区', '内门区', '永安区', '六龟区', '杉林区', '田寮区', '甲仙区',
      '桃源区', '那玛夏区', '茂林区',
    ],
    ...
    '彰化县': [
      '彰化市', '员林市', '和美镇', '鹿港镇', '溪湖镇', '二林镇', '田中镇', '北斗镇', '福兴乡', '花坛乡', '社头乡', '秀水乡', '伸港乡', '大村乡', '永靖乡', '埔心乡',
      '芳苑乡', '埔盐乡', '埤头乡', '溪州乡', '田尾乡', '芬园乡', '线西乡', '大城乡', '二水乡', '竹塘乡',
    ],
    '南投县': [ '南投市', '草屯镇', '埔里镇', '竹山镇', '集集镇', '名间乡', '国姓乡', '鹿谷乡', '水里乡', '信义乡', '仁爱乡', '鱼池乡', '中寮乡', ],
    '云林县': [
      '斗六市', '虎尾镇', '西螺镇', '斗南镇', '北港镇', '土库镇', '麦寮乡', '古坑乡', '莿桐乡', '口湖乡', '二仑乡', '元长乡', '水林乡', '仑背乡', '台西乡',
      '四湖乡', '大埤乡', '林内乡', '东势乡', '褒忠乡',
    ],
    '嘉义县': [
      '朴子市', '太保市', '大林镇', '布袋镇', '民雄乡', '水上乡', '中埔乡', '竹崎乡', '新港乡', '东石乡', '六脚乡', '梅山乡', '义竹乡', '鹿草乡', '溪口乡',
      '番路乡', '阿里山乡', '大埔乡',
    ],
    '屏东县': [
      '屏东市', '潮州镇', '东港镇', '恒春镇', '内埔乡', '万丹乡', '新园乡', '长治乡', '里港乡', '盐埔乡', '高树乡', '枋寮乡', '九如乡', '万峦乡', '佳冬乡', '林边乡',
      '竹田乡', '崁顶乡', '琉球乡', '麟洛乡', '南州乡', '新埤乡', '车城乡', '满州乡', '三地门乡', '来义乡', '玛家乡', '枋山乡',
      '泰武乡', '牡丹乡', '狮子乡', '春日乡', '雾台乡',
    ],
